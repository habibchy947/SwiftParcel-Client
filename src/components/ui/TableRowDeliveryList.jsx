            ...
            <TableCell className="whitespace-nowrap flex gap-1">
                <Dialog>
                    ...
                    <DialogContent className="max-w-2xl">
                        ...
                        <MapContainer key={`map-${_id}`} center={position} zoom={12} style={{width: '600px', height: '500px'}}>
                            <TileLayer
...
{/* <MapContainer key={_id} center={position} zoom={12} style={{ width: '600px', height: '500px' }}>
    <TileLayer
        url='https://api.maptiler.com/maps/basic-v2/256/{z}/{x}/{y}.png?key=BefSPM9r2086N4GtobHL'
        attribution='<a href="https://www.maptiler.com/copyright/" target="_blank">&copy; MapTiler</a> <a href="https://www.openstreetmap.org/copyright" target="_blank">&copy; OpenStreetMap contributors</a>'
    >
