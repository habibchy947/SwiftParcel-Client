    ...
    return (
        <TableRow className="" key={idx}>
            ...
            <TableCell className="whitespace-nowrap">
                 <p className={`text-center ${status === 'cancelled' && 'text-red-500 bg-red-50'} ${status === 'pending' && 'text-yellow-500 bg-yellow-50'} ${status === 'onTheWay' && 'text-pink-500 bg-pink-50'} ${status === 'delivered' && 'text-green-500 bg-green-50'} py-1 rounded-2xl`}>{status}</p>
                 </TableCell>
